...
class Friend_Fragment : Fragment(), FriendAdapter.OnItemClickListener{
    ...
    private fun fnRecyclerSet(){
        ...
        adapter = FriendAdapter(mainViewmodel.friendsProfileList.value,this)
